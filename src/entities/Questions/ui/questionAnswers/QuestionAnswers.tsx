...
export const QuestionAnswers = ({title, contentAnswer, needExpand, initialValue, maxHeight} : Props) => {
  const htmlContent = contentAnswer ? marked.parse(contentAnswer) : '';
  const [isExpand, toggle] = useToggle(initialValue); 
  ...
  return (
    <div className={styles.answer_container}> 
      ...
      <div 
        ...
        style={{
          maxHeight: isExpand ? '2000px' : maxHeight || '400px',
          overflow: 'hidden',
